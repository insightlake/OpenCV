...
# closes when we interrupt it by clicking any button
'''
...
cv2.waitKey(0)
cv2.destroyAllWindows()  #  kill all pop ups
'''
...
# we create matrix of our image so that we can do masking of the image.
...
#calculate blurness of the image
sample = cv2.imread('sample.jpg')
